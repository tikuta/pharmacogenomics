...
saving_path = '../../results/filter/4_0_filter_vcf_on_other_classes_canonical_isoform'
...
#copied from 3_0_filter_vcf_on_classA_canonical_isoform.py
for gpcr_class in gpcr_classes:
    ...
    for dataset in datasets:
        ...
        file_write = open('{}/on_{}_canonical_isoforms.vcf'.format(saving_path_dataset,gpcr_class),'w')
